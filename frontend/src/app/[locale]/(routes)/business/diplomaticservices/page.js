import HeroSectionDS from './components/HeroSectionDS'
import Services from './components/Services'
import SecurityStandards from './components/SecurityStandards'
import HighLevelTravel from './components/HighLevelTravel'
import SeemlessJourney from './components/SeemlessJourney'
...
export default function Page() {
  const t = useTranslations('Navigation7')
  return (
    <main>
      <HeroSectionDS />
